...
public class UpdateJobResourceRequirementsITCase {
    ...
    private static Configuration createConfiguration() {
        ...
        configuration.set(HeartbeatManagerOptions.HEARTBEAT_INTERVAL, 50L);
                ...
                () ->
                        JobResourceRequirements.newBuilder()
                                .setParallelismForJobVertex(
                                        jobVertex.getID(), 1, parallelismAfterRescaling)
                                .build(),
                initialParallelism,
    ...
    void testManualDownScaling() throws Exception {
        ...
        runRescalingTest(
                ...
                () ->
                        JobResourceRequirements.newBuilder()
                                .setParallelismForJobVertex(jobVertex.getID(), 1, 1)
                                .build(),
                initialRunningTasks,
                runningTasksAfterRescale,
                NUMBER_OF_SLOTS - 1);
    ...
    private void runRescalingTest(
            JobGraph jobGraph,
            Supplier<JobResourceRequirements> newJobVertexParallelismSupplier,
        ...
        try {
            ...
            final JobResourceRequirements jobResourceRequirements =
                    newJobVertexParallelismSupplier.get();
            ...
            clusterClient.cancel(jobGraph.getJobID()).join();
        }
    }
