...
/** Tests for {@link JobResourceRequirements}. */
@ExtendWith(TestLoggerExtension.class)
public class JobResourceRequirementsTest {
    ...
    @Test
    void testWriteToJobGraphAndReadFromJobGraph() throws IOException, ClassNotFoundException {
