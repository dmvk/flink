...
public class JobResourceRequirements implements Serializable {
    ...
    public static final class Builder {
        ...
        public Builder setJobVertexResourceRequirements(
                JobVertexID jobVertexId,
                JobVertexResourceRequirements jobVertexResourceRequirements) {
            vertexResources.put(jobVertexId, jobVertexResourceRequirements);
            return this;
        }
