...
/**
 * {@code CheckpointJobDataCleanupRunner} implements {@link JobManagerRunner} in a way, that only
 ...
 */
public class CheckpointJobDataCleanupRunner implements JobManagerRunner {

    private static final Logger LOG = LoggerFactory.getLogger(CheckpointJobDataCleanupRunner.class);
    ...
    public CheckpointJobDataCleanupRunner(
            JobResult jobResult,
