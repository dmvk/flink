 ...
 */
public class JobVertexFlameGraphHeaders implements MessageHeaders<EmptyRequestBody, JobVertexFlameGraphInfo, JobVertexMessageParameters> {

	private static final JobVertexFlameGraphHeaders INSTANCE = new JobVertexFlameGraphHeaders();

	private static final String URL = "/jobs/:" + JobIDPathParameter.KEY + "/vertices/:" + JobVertexIdPathParameter.KEY + "/flamegraph";
	...
	@Override
	public Class<JobVertexFlameGraphInfo> getResponseClass() {
		return JobVertexFlameGraphInfo.class;
	}
